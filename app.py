...
selected_locations = st.multiselect(
    "Select locations to view forecast",
    options=list(files.keys()),
...
selected_locations = st.multiselect(
    "Select locations to view forecast (Multiple)",
    options=list(files.keys()),
    default=list(files.keys())
)
...
for location in selected_locations:
    ...
    fig.update_layout(title=f"{location} - AQI Forecast", xaxis_title="Date", yaxis_title="AQI", template="plotly_white")
